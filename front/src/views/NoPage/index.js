    ...
    return (
      <div className='pos-a t-0 l-0 bgc-white w-100 h-100 d-f fxd-r fxw-w ai-c jc-c pos-r p-30'>
        ...
        <div className='d-f jc-c fxd-c'>
          ...
          <h3 className='mB-10 fsz-lg c-grey-900 tt-c'>Vaya, página no encontrada</h3>
          <p className='mB-30 fsz-def c-grey-700'>La página que buscas no existe o se encuentra en otro sitio.</p>
          {/*<div>
